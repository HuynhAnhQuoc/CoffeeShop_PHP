...
<head>
    ...
    <title>Cà Phê Đóng Gói | Coffee Shop</title>
</head>
<?php
    require './site.php';
?>
                ...
                <div class="col l-9 m-12 c-12">
                    <div class="row">
                        <?php
                            ...
                            $kqua1 = mysqli_query($conn, "SELECT * FROM product WHERE type = 'packaged_coffee'") or die(mysqli_error($conn));
                            $columnPage = 6;
                            ...
                            $kqua2 = mysqli_query($conn, "SELECT * FROM product WHERE type = 'packaged_coffee' LIMIT $vtpage, $columnPage") or die(mysqli_error($conn));
                        ...
                        <div class="page page-menu">
                            <?php
                                ...
                                {
                                    $x = $page -2;
                                    echo '<a href="packaged_coffee.php?page='.$x.'" class="back-page"><<</a>';
                                }
                                if($page > 0)
                                {
                                    $x = $page - 1;
                                    echo '<a href="packaged_coffee.php?page='.$x.'" class="number-page">'.($x+1).'</a>';
                                }
                                ...
                                {
                                    $x = $page + 2;
                                    echo '<a href="packaged_coffee.php?page='.$x.'" class="up-page">>></a>';
                                }
        ...
        if (isset($_POST['username']) && isset($_POST['password'])) {
            ...
            if (mysqli_num_rows($check) == 0) {
                ...
                if ($password != $row['pass']) {
                    ...
                    echo "<script type='text/javascript'>window.location='packaged_coffee.php'</script>";
                }
            }
        }
